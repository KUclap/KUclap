...
import { ModalHeader } from "../common/DesignSystemStyles";
import Modal from "../common/Modal";
import { CopyLink, Facebook, Line, Share, Twitter } from "../utility/Icons";
...
const ShareModal = (props) => {
	const { showShareModal, closeShareModal, reviewId, classId, classNameTH } = props;
	...
	return (
		<Modal showModal={showShareModal} closeModal={closeShareModal} type="ShareModal">
			<ModalHeader>
				แบ่งปันรีวิว
				<Share />
			</ModalHeader>
